...
export default function Checkout() {
  ...
  const handleNext = () => {
    if (activeStep === 0 && !selectedUserAddress) {
      toast.error("Please select checkout adress before proceeding.");
      return;
    }
      ...
      >
        ...
        {activeStep !== steps.length - 1 && (
          <button
            ...
            className={`px-6 h-10 bg-blue-600 text-white font-medium rounded hover:bg-blue-700 transition-all
              ${
                errorMessage ||
